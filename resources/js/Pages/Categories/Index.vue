            ...
            <div class="grid lg:grid-cols-12 w-full">
                <div class="lg:col-start-4 lg:col-end-13 lg:mx-2 table-responsive">
                    ...
                    <div class="mb-3 mx-3">
                        ...
                        <inertia-link href="/categories/create" type="submit" class="btn btn-outline-primary text-white float-right px-3 flex">
                    ...
                    <div v-if="categories.data.length > 0" class="border border-white">
                        <table class="table table-dark table-hover table-striped text-center text-white table-fixed align-middle">
                            <thead>
                                <tr class="text-muted">
                                    <th>
                                        <inertia-link class="flex justify-center" href="#" @click="sort('cat_name')">Name
                            ...
                            <tbody>
                                <tr v-for="cat in categories.data" :key="cat.id" @click="selectCat(cat.id)" class="cursor-pointer">
                                    <th>{{ cat.cat_name }}</th>
                    ...
                    <div v-else class="text-center mt-5">
                        <h1 class="text-white text-4xl my-4">No Categories added</h1>
                        <inertia-link class="lead text-decoration-none text-blue-300 hover:text-yellow-400 transition duration-500" href="/categories/create">Create</inertia-link>
                    </div>
                    <!--  Pagination  -->
...
<script>
    ...
    export default {
        ...
        methods:{
            selectCat(e){
                Inertia.visit(`/categories/${e}/edit`)
            },
            sort(field){
            ...
            params:{
                handler: throttle(function () {
                    ...
                    this.$inertia.get('/categories', params, {replaces: true, preserveState: true})
                },10),
                deep:true,
            }
        },
